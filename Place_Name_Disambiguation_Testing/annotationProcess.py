...
def combine_data():
    path = "../../CompletedEmbeddings/CompletedBertEmbeddings/QuakeTextCompletedBert.csv"
    ...
    quakeCore.to_csv('QuakeTextCompletedBertWithCorrectInstance.csv', index=False)


def get_coordinates(conn_engine):
    path = 'QuakeTextCompletedBertWithCorrectInstance.csv'
    ...
    data.to_csv('QuakeTextCompletedBertWithCorrectInstanceAndCoords.csv', index=False)
